...
alert(sessionStorage.getItem("lista_canciones"));
  ...
  if(canciones != undefined){
    ...
    for(i=inicio; i<(elem_por_pagina+inicio) && i<canciones.length;i++){
      ...
      var l='<form name="accionCancion" method="post" action="#"><div class="cancioninf"><ul><li id="barraopciones"><a href="cancion.html" id="enlacecancion"><div class="imagen"><img src="img/edsheeranperfect.jpg" alt="Imagen cancion"></div></a></li><li id="barraopciones"><div class="nombre_autor_cancion"><a href="cancion.html" id="enlacecancion"><div class="nombrecancion">Perfect</div></a><a href="artista.html" id="enlacecancion"><div class="nombreautor">Ed Sheeran</div></a></div></li><li id="barraopciones"><div class="simb_repr_play"><input type="image" src="img/play.png" alt="Reproducir cancion" title="Reproducir canción"';
