      ...
      $.ajax({
       ...
       if(obj.error != undefined){
         ...
         for(i=inicio; i<(elem_por_pagina+inicio) && i<canciones.length;i++){
           ...
           n_genero= ""; //No mostrar genero porque es el mismo (pagina genero)
           if(n_album==null){
             n_album= "";
           }
         ...
         if((elem_por_pagina+inicio)<canciones.length){
           ...
           var boton_mas = '<br><br><form action="estilo.html"><button type="submit" id="boton_mostrar_mas" class="aumentar">Mostrar más</button><input type="hidden" name="estilo" value="'+c+'"/><input type="hidden" name="pagina" value="'+pagina_sig+'"/></form>';
